...
import { useFile } from "@/Features/Hooks/use-files"
...
const Tab = ({
    ...
    return (
        ...
        className={cn("flex items-center gap-2 h-8.75 pl-2 pr-1.5 cursor-pointer text-muted-foreground border-y border-x group border-transparent hover:bg-accent/30",isActive && "bg-background text-foreground border-x-border border-b-background -mb-px drop-shadow",isFirst && "border-l-transparent!")}
